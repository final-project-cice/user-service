...
INSERT INTO usr(id, first_name, last_name, email, password, birthday) VALUES (3, 'Tsyupryk', 'Roman', 'user_3@gmail.com', 'strong_password', TO_DATE('02-JAN-1970', 'DD-MON-YYYY'));

INSERT INTO usr(id, first_name, last_name, email, password, birthday) VALUES (4, 'First Name User_4', 'Last Name User_4', 'user_4@gmail.com', 'strong_password', TO_DATE('03-JAN-1970', 'DD-MON-YYYY'));